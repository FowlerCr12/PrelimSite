...
navlinks_refresh = dmc.Stack(
    [
        ...
        dmc.NavLink(
            label="Need Review",
            leftSection=get_icon("tabler:file-isr"),
            href="/dash/page1",
            refresh=False,
            variant="subtle",
        ),
        dmc.NavLink(
            ...
            leftSection=get_icon("tabler:users"),
        ...
        dmc.NavLink(
            ...
            leftSection=get_icon("tabler:device-desktop-analytics"),
            href="/dash/statsDashboard",
            refresh=True,
            variant="subtle",
        ),
    ],
...
header = dmc.AppShellHeader(
    dmc.Group(
        [
            ...
            dmc.Image(src="/dash/assets/cnclogo.png", w=50, h=50, ml=10, mr=10),
